          ...
          <>
            <div style={{display : "flex",marginTop: "1%",alignItems: "center", justifyContent: "center", padding: "10px",marginRight : ""}}>
              ...
              <div id = 'solde' style ={{display: (document.querySelector("#token").textContent !== "") ? "block" : "none"}}>
                <Link to="/recharge">
                  <Bouton style ={{marginRight : "10em", width : "10em", marginTop : "-10px"}} value={"recharger"}>Solde : {localStorage.getItem("solde")===null ? '0' : localStorage.getItem("solde")} €</Bouton>
                </Link>
              </div>
              <div className = 'menu-container'>
                <div style={{ marginTop: "1em", display: (document.querySelector("#token").textContent !== "") ? "block" : "none"}}  id="MonCompte">
                  ...
                  <div id = 'messagerie'>
                    <Link to="/messagerie">
                       <img src = {imgUtil.messagerieImg} style={{...imgUtil.img, marginRight : "5em",top: "28px",right: "20px", height: "45px",width: "50px",borderRadius: "27%"}} ></img>
                    </Link>
                  </div>
